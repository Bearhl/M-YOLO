...
def iou_ours(pred, gt):  # require pred and gt is numpy
...
def parse_args():
    ...
    # general
    parser.add_argument('--cfg', help='experiment configure file name', default="Tacos.yaml", type=str)
...
if __name__ == '__main__':
    ...
    print(np.array(prediction).shape, np.array(val_data).shape)
